...
try:
    import SI5351A_CP2112 as SI5351A
except ImportError as e:
    print(f"Error: Could not import SI5351A_CP2112 module: {e}")
    print("Make sure SI5351A_cp2112_complete.py is in the same directory and hidapi is installed.")
    print("Install hidapi using: pip install hidapi")
    exit(1)
except Exception as e:
    print(f"Error: Failed to initialize CP2112 device: {e}")
    print("Make sure the CP2112 device is properly connected and recognized by your system.")
    exit(1)
